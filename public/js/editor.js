...
/**
 * usage details ar http://www.jqueryscript.net/text/Responsive-WYSIWYG-Text-Editor-with-jQuery-Bootstrap-LineControl-Editor.html
 */
            ...
            var menuItems = { 'fonteffects': true,
                ...
                'insert_link': { "modal": true,
                    ...
                    "onSave": function () {
                        ...
                        $(this).data("editor").find('a[href="' + targetURL + '"]').each(function () {
